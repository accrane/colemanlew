...
var project             = 'Coleman Lew'; // Project Name.
var projecturl          = 'http://localhost:8888/Bellaworks/colemanlew/site/bw/'; // Project URL. Could be something like localhost:8888.
...
gulp.task( 'vendorsJs', function() {
	...
	gulp.src( [
		...
		//'./assets/js/vendors/jquery.lettering-0.6.1.min.js',
